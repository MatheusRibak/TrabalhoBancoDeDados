...
public class TelaProcurarVenda extends JFrame implements ActionListener, KeyListener{
	...
	private void criarCamposBusca() {
		...
		jlbProVendedor = cl.criarLabelParaPanel("Vendedor:", 345, 39, 100, 24, jlbProVendedor, tela);
		...
		jtfProVendedor = cf.criarTextField(450, 39, 250, 24, jtfProVendedor, tela, this);
